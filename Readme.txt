...
Tags: recent purchases, purchases, last purchases, woocommerce, woocommerce recent purchases,woo recent purchases, woo
...
Display last purchases that were made via of Woocommerce Plugin

== Description ==
Plugin Woocommerce Recent Purchases is designed to show the last purchases that were made with the help of [Woocommerce](https://wordpress.org/plugins/woocommerce/) Plugin.
This Plugin outputs the list of the last purchases with the predefined users' settings.

= Demo =
You can see Recent Purchases on sidebar on [this page](https://wow-estore.com/item/wow-modal-windows-pro/) 
